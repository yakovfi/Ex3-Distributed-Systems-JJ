...
$(document).ready(function () {
    ...
    function DetailsOfTheGuide(id_s, nameId) {
        ...
        if ($("#" + id_s).click(function () {
            ...
            let guide;
            //Take the guide of the trip
            guideArr.forEach(e => {
                if (e._id == objArr[nameId].guide) {
                    guide = e;
                }
            });
            cell1.innerHTML =
                "name: " + guide.Guide_Name + "<br />" + "<br />" +
                "email: " + guide.Guide_Email + "<br />" + "<br />" +
                "cellular: " + guide.Guide_Cell + "<br />" + "<br />";
    ...
    function deleteT(arrButtons, arrCounter, nameId) {
        ...
        for (let i = 0; i < arrButtons.length; i++) {
            ...
            if ($("#" + id_s).click(function () {
                ...
                let tempUrl = '/tour/' + objArr[nameId].id;
